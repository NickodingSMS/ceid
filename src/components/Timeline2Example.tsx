...
import { Timeline2, TimelineItem, createTimelineItem, TimelineVariants } from './Timeline2';
import { 
  CheckCircleIcon, 
  ClockIcon, 
  PlayCircleIcon,
...
export const Timeline2Example: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-12">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Timeline2 Component Examples</h1>
...
{`import { Timeline2, createTimelineItem } from './Timeline2';
...
export default Timeline2Example;
